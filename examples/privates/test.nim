...
var
    r1: Ray = newRay(newPoint(-2.0, 0.0, 0.0), newVector3(5/2, 1/2, 1/2), min, max) # dir norm = (0.96, 0.19, 0.19)
    r2: Ray = newRay(newPoint(-2.0, 0.0, 0.0), newVector3(5/2, 1/2, -1/2), min, max) # dir norm = (0.96, 0.19, -0.19)
